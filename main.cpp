...
int main()
{
    System system(0.0, 0.1); // Initialize the system with time 0.0 and dt 0.1
    ...
    object1.motion.velocity = {0.0, 0, 0}; // Set the velocity of the object
    object1.setMass(10000.0); // Set the mass of the object
    system.add_object(std::make_shared<Object>(object1)); // Add the object to the system

    object2.motion.position = {0.0, 1.0, 0.0}; // Set the position of the object
    object2.motion.velocity = {0.0, 1.0, 0}; // Set the velocity of the object
    object2.setMass(1.0); // Set the mass of the object
    ...
    object3.motion.velocity = {0.0, 0.0, 1.0}; // Set the velocity of the object
    ...
    for (int i = 0; i < 100; ++i) // Update the system 10 times
    {
